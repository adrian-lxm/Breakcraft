...
public class PlayerJoinListener implements Listener {
    ...
    public void onPlayerJoin(PlayerJoinEvent e) {
        ...
        blank.setScore(1);
        double money = SurvivalPlugin.getInstance().econ.getBalance(e.getPlayer());
        ...
        blank3.setScore(7);
        int count = 0;
        try(Connection connection = SurvivalPlugin.dataSource.getConnection(); PreparedStatement preparedStatement = connection.prepareStatement("SELECT * from ServerInfo WHERE id = 1")) {
        ...
        SurvivalPlugin.infos.put(e.getPlayer(), new Score[] { players, balance });
        if(!(SurvivalPlugin.ccm.claimCount.containsKey(e.getPlayer()))) {
            SurvivalPlugin.ccm.claimCount.put(e.getPlayer(), 0);
        }
    ...
    public void onLeave(PlayerQuitEvent e) {
        ...
        SurvivalPlugin.infos.remove(e.getPlayer());
    }
