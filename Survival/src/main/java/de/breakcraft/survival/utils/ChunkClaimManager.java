...
public class ChunkClaimManager {
  ...
  public void initManager() {
    try(Connection connection = SurvivalPlugin.dataSource.getConnection(); PreparedStatement preparedStatement = connection.prepareStatement("select * from ChunkClaims")) {
